...
HD_PWD='D:/Tudor/School/DSD/Vivado/Picoblaze_Basys3/Picoblaze_Basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microcontroller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microcontroller.tcl
