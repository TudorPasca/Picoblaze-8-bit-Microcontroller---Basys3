...
HD_PWD='D:/Tudor/School/DSD/Vivado/Picoblaze_Basys3/Picoblaze_Basys3.runs/impl_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log microcontroller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microcontroller.tcl -notrace
